<template>
  <v-dialog v-model="showModal" width="80%" height="80%" persistent>
    <v-card class="esg-guide-modal">
      <div class="modal-container">
        ...
        <div class="modal-header">
          <div class="text-center mb-4">
            ...
            <div class="logo-container mb-2">
              <img src="/icons/dds/logo.svg" alt="Dimitra ESG Logo" class="esg-logo" />
            </div>
        ...
        <div class="modal-footer">
          <div class="footer-content">
            <!-- Top Row: Checkbox and Download PDF Button -->
              ...
              <div class="checkbox-section">
                ...
                >
                  <template v-slot:label>
                    <span class="checkbox-label">Don't Show this Screen Again</span>
                  </template>
                </v-checkbox>
              </div>
  ...
  methods: {
    ...
    continueToESG() {
      ...
      if (this.dontShowAgain) {
        localStorage.setItem('esg-guide-dismissed', 'true');
      }
