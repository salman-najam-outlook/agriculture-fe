    ...
    >
        <v-card>
            ...
            >
                ...
                <v-toolbar-title class="white--text">{{ $t('blends.blendSettings.confirmation') }}</v-toolbar-title>
                <v-spacer></v-spacer>
                <v-btn
                    color="white"
                    icon
            ...
            <v-card-text class="pt-5 black--text text-center">
                {{ message? message : this.$t('blends.blendSettings.confirmMessage') }}
            ...
            <v-card-actions >
                ...
                >
                    {{ cancelBtnText? cancelBtnText : this.$t('blends.blendSettings.cancel') }}
                </v-btn>
                <v-btn
                    depressed
                    color="primary"
                ...
                >
                    {{ confirmBtnText? confirmBtnText : this.$t('blends.blendSettings.confirm') }}
                </v-btn>
            </v-card-actions>
            </v-card-text>
        </v-card>
