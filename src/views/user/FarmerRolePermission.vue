      ...
      <v-card class="" rounded="0">
        <v-toolbar flat color="primary" class="white--text">
          <v-toolbar-title class="font-weight-bold">{{
            $t("userslist.farmerRolePermission")
          }}</v-toolbar-title>
          <v-spacer></v-spacer>
        ...
        <v-card-text class="pb-15">
          ...
          <v-expansion-panels v-else flat focusable v-model="panel" multiple>
            <v-expansion-panel
              class="mt-5"
...
export default {
  ...
  mixins: [loadingMixin, generalMixin, PermissionsMixin, getPermittedActions],
};
</script>
