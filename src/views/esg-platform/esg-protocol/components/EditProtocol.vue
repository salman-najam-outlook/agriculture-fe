      ...
      <v-card>
        <v-toolbar color="primary" dark flat>
          <v-toolbar-title class="white--text">
            {{ $t('esgPlatform.editProtocol') }}</v-toolbar-title>
          <v-spacer></v-spacer>
            ...
            <v-row class="pt-4">
              ...
              <v-col cols="12">
                ...
                <v-text-field :placeholder="$t('esgPlatform.dashboard.enterHere')" v-model="formData.shortCode" outlined
                  dense :rules="[rules.required, rules.email]"></v-text-field>
              </v-col>
              ...
              <v-col cols="12">
                ...
                <div class="upload-container mt-4">
                  ...
                  <div class="upload-box d-flex flex-column align-center justify-center" @click="triggerFileInput">
                    <v-img v-if="formData.sealUrl" :src="formData.sealUrl" class="preview-image" contain></v-img>
        ...
        handler(newVal) {
          if (newVal) {
            this.formData = {
              ...
              sealUrl: newVal.sealUrl,
              sealKey: newVal.sealKey,
            };
          }
        },
      },
    ...
    methods: {
      ...
      async uploadImageToS3(file) {
        ...
        try {
          ...
          if (uploadResponse.status === 200) {
            ...
            this.formData.sealUrl = publicUrl?.data;
          } else {
      ...
      async saveProtocol() {
        ...
        try {
          ...
          const data = await ESGService.updateEsgStandard(payload.id, payload);
