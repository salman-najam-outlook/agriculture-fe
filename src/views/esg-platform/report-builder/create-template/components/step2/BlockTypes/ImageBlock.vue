<template>
    <div class="image-block" v-if="!preview">
        ...
        <div v-if="block.imageType === 'single'">
            ...
            <div v-if="block.images[0] && block.images.length" class="single-image-preview">
                <v-img :src="block.images[0]" height="120" contain />
                  <v-btn v-if="block.images[0]" icon color="error" class="delete-btn" @click="removeImage(0)">
...
export default {
    ...
    methods: {
        ...
        onSingleImageChange(e) {
            ...
            if (file) {
                ...
                reader.onload = (evt) => {
                    ...
                    // clear file input so re-selecting same file triggers change
        ...
        onGridImageChange(e, idx) {
            ...
            if (file) {
                ...
                reader.onload = (evt) => {
                    ...
                    const ref = this.$refs['gridFileInput' + idx];
        ...
        removeImage(idx) {
            ...
            if (this.$refs.fileInput) this.$refs.fileInput.value = '';
            const gridRef = this.$refs['gridFileInput' + idx];
            if (gridRef && gridRef[0]) gridRef[0].value = '';
        },
