                ...
                <v-container fluid>
                    <v-row class="d-flex mb-5">
                        <v-col cols="3">
                            ...
                            <div class=" subtitle-1 black--text font-weight-bold">Area Unit</div>
                        ...
                        <v-col cols="9">
                                ...
                                <v-card class="ml-10" flat
                                    ...
                                    <v-card-text class="py-2">
                                        <v-row class="d-flex space-between">
                                            <v-col cols="6" class="text-left pl-5"> Perimeter: {{ perimeterToShow }}
                                            </v-col>
                            ...
                            <div class="d-flex justify-center mt-n12">
                                <v-btn v-if="(startGeoFence && parentPolygonCoords.length >= 3)" @click="saveGeoFence"
                                    width="200" color="primary" class="" depressed>SAVE</v-btn>
                            </div>
                        </v-col>
                    </v-row>
                </v-container>
