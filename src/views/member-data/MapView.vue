    ...
    <div>
        ...
        <v-row class="ml-2">
            <v-col cols="6">
                <v-card class="pa-3 color-card">
                    ...
                    <div class="farm-info mt-5">
                        <div class="farm-el">
                            <p class="mb-2 neutral-c"> Date Of Entry </p>
                            <p class="font-weight-bold mb-2"> {{ viewFarmOnMap.createdAt }} </p>
                        </div>

                        <div class="farm-el">
                            <p class="mb-2 neutral-c"> Farm Id </p>
                            <p class="font-weight-bold mb-2"> {{ viewFarmOnMap.id }} </p>
                        </div>

                        <div class="farm-el">
                            <p class="mb-2 neutral-c"> Ownership Type </p>
                            <p class="font-weight-bold mb-2"> {{ viewFarmOnMap.farmOwnershipType }} </p>
                        </div>

                        <div class="farm-el">
                            <p class="mb-2 neutral-c"> Total Size </p>
                            <p class="font-weight-bold mb-2"> {{ viewFarmOnMap.area }} Acre </p>
                        </div>

                        <div class="farm-el">
                            <p class="mb-2 neutral-c"> Location </p>
                            <p class="font-weight-bold mb-2"> {{ viewFarmOnMap.address }} </p>
                        </div>

                        <div class="farm-el">
                            <p class="mb-2 neutral-c"> Goal Type </p>
                            <p class="font-weight-bold mb-2" v-if="viewFarmOnMap.farmGoals.length"> {{
                                viewFarmOnMap.farmGoals[0].farmingGoal }} </p>
                        </div>
                        <div class="farm-el">
                            <p class="mb-2 neutral-c"> Production Type </p>
                            <p class="font-weight-bold mb-2"> {{
                                viewFarmOnMap.productionType }} </p>
                        </div>
                        <div class="farm-el">
                            <p class="mb-2 neutral-c"> Certifications </p>
            ...
            <v-col cols="6" v-if="center && farmCoordinate.length">
                <GmapMap :center="center" :zoom="18" map-type-id="satellite" style="width: 100%; height: 800px;">
                    />
    ...
    methods: {
        ...
        showInfoWindow(coordinates) {
            ...
            this.infoWindowContent =
             ...
             Geofence : ${this.viewFarmOnMap?.zones.map(item=>item.geofenceName)}
             `
        },
        hideInfoWindow() {
